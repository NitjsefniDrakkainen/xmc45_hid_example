...
#
# \brief
# Define the KIT_XMC45_RELAX_V1 target.
#
################################################################################
# \copyright
...
MPN_LIST:=XMC4500-F100x1024
DEVICE:=XMC4500-F100x1024
DEVICE_COMPONENTS:=CAT3 XMC45XX
DEVICE_LIST:=XMC4500-F100x1024
DEVICE_TOOL_IDS:=bsp-assistant device-configurator library-manager memory-analyzer project-creator
DEVICE_XMC4500-F100x1024_CORES:=CORE_NAME_CM4_0
DEVICE_XMC4500-F100x1024_DIE:=XMC4500
DEVICE_XMC4500-F100x1024_FLASH_KB:=1024
DEVICE_XMC4500-F100x1024_SRAM_KB:=160
